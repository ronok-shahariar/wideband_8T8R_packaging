...
""")
    ...
    #
    # Bundle layout:
    #   <bundle_root>/XRComm_8T8R_playback/bin/playback_grpc_server.py
    #   <bundle_root>/XRComm_8T8R_playback/inputs/config.ini
    #
    # One level up from this file lands on XRComm_8T8R_playback/.
