...
Default playback root is computed relative to this script's location:
  <this file>/../..
i.e. the 8T8R/playback directory that contains this XRComm_platform_gRPC/ folder.
...
""")
    ...
    #
    # Bundle layout:
    #   <bundle_root>/8T8R/playback/XRComm_platform_gRPC/server/playback_grpc_server.py
    #   <bundle_root>/8T8R/playback/inputs/config.ini
    #
    # Two levels up from this file lands on 8T8R/playback/.
