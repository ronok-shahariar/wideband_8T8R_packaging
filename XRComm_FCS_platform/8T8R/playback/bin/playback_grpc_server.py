...
the 8T8R playback tree:
  ...
  * GetPlaybackDiagnostics / WatchPlaybackDiagnostics return steady-state
    playback metrics.
...
NOTE: in this customer bundle this Python server is shipped as the playback
gRPC entrypoint.
"""
...
# Generated stubs are shipped with the package.
...
DEFAULTS = {
    ...
    "tx_port_id": [1, 0],
    "dest_mac": ["00:00:00:00:00:00", "00:00:00:00:00:00"],
}
...
Default playback root is computed relative to this script's location:
  <this file>/..
i.e. the 8T8R/playback directory that contains this bin/ folder.
...
""")
    ...
    #
    # Bundle layout:
    #   <bundle_root>/8T8R/playback/bin/playback_grpc_server.py
    #   <bundle_root>/8T8R/playback/inputs/config.ini
    #
    # One level up from this file lands on 8T8R/playback/.
    ...
    ap.add_argument(
        ...
        help=f"Path to 8T8R/playback/ (default: {_default_root})",
    )
